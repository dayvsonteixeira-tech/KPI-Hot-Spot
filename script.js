...
// O plugin de rótulos de valores precisa ser registrado explicitamente
// (não vem ligado por padrão no Chart.js v4).
    ...
    data:{
      ...
      datasets:[
        { label:"Hot", data:months.map(m=>m.hot), backgroundColor:COLORS.orange, stack:"s",
          datalabels:{ color:"#fff", font:{weight:"bold", size:11}, clamp:true,
